                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">  اسم العروض </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{URL::to('/admin/offers' , [$offer->id , 'edit'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
                                    <td class="text-center">
                                        {{Form::open(['route'=>['admin.offers.destroy' , $offer->id] , 'method'=>'delete' , 'id'=>'form'])}}
