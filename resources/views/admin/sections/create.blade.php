...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1535px">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">اضافة قسم رئيسي</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">اضافة قسم رئيسي جديد</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        ...
                        <!-- BEGIN FORM-->
                        {{Form::open(['route' => 'admin.sections.store' , 'class' => 'form-horizontal' , 'files' => 'true'])}}
                        <div class="form-body">
