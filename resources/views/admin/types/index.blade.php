                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> الاقسام الداخلية</span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">  القسم الداخلي</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> {{$type->getSection->name_ar}} </td>
                                    <td class="text-center"> {{$type->getBranch->name_ar}} </td>
                                    <td class="text-center"> {{$type->name_ar}} </td>
                                    <td class="text-center"><a href="{{URL::to('/admin/types' , [$type->id , 'edit'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
