...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1535px">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">تعديل  اعلان</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">تعديل اعلان</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        {{Form::open(['route' => ['admin.ads.update' , $ad->id] , 'class' => 'form-horizontal' , 'method' =>'PUT' , 'files' =>'TRUE'])}}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {{Form::text('link' ,$ad->link , ['class' => 'form-control'])}}
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <img src="{{URL::to('/').'/images/ads/'.$ad->image}}" width="100px;" />
                                </div>
                            </div>
