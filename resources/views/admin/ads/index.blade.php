                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">الاعلانات </span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> <img src="{{URL::to('/').'/images/ads/'.$ad->image}}" width="100px;" sty /> </td>
                                    <td class="text-center"><a href="{{URL::to('/admin/ads' , [$ad->id , 'edit'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
                                    <td class="text-center">
                                        {{Form::open(['route'=>['admin.ads.destroy' , $ad->id] , 'method'=>'delete' , 'id'=>'form'])}}
