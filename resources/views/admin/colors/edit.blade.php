...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1535px">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">تعديل بيانات اللون</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">تعديل بيانات اللون</span>
                        </div>
                        <div class="actions">
                                <a href="{{URL::to('/admin/colors')}}" class="btn btn-primary">عرض جميع الالوان</a>
                        </div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <!-- BEGIN FORM-->
                        {{Form::open(['route' => ['admin.colors.update' , $color->id] , 'class' => 'form-horizontal' , 'method' => 'patch'])}}
                        <div class="form-body">
