                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">الالوان </span>
                        </div>
                        <div class="tools"> </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> {{$color->name_ar}} </td>
                                    <td class="text-center"> {{$color->name_en}}</td>
                                    <td class="text-center"><a href="{{URL::to('/admin/colors' , [$color->id , 'edit'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
                                    <td class="text-center">
                                        {{Form::open(['route'=>['admin.colors.destroy' , $color->id] , 'method'=>'delete' , 'id'=>'form'])}}
