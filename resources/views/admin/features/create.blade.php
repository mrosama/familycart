...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1535px">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">اضافة  خاصية</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">اضافة خاصية</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        ...
                        <!-- BEGIN FORM-->
                        {{Form::open(['route' => 'admin.features.store' , 'class' => 'form-horizontal'])}}
                        <div class="form-body">
