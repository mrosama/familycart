...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1535px">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">  تعديل بيانات المدينة  </span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">   تعديل بيانات المدينة  </span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        ...
                        <!-- BEGIN FORM-->
                        {{Form::open(['route' =>['admin.cities.update' ,  $city->id] , 'class' => 'form-horizontal' , 'method' => 'patch'])}}
                        <div class="form-body">
                            <!-- Flash Message -->
                            @if($errors->any())
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">اسم المدينة الرئيسي
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    {{Form::text('charge_value' , $city->charge_value , ['class' => 'form-control'])}}
                                </div>
                            </div>
